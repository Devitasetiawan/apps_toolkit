    ...
    <div class="top-bar-boxed h-[70px] z-[51] relative border-b border-white/[0.08] mt-12 md:-mt-5 -mx-3 sm:-mx-8 px-3 sm:px-8 md:pt-0 mb-12">
        <div class="h-full flex items-center">
            ...
            <div class="intro-x dropdown mr-4 sm:mr-6">
                ...
                <a href="<?= site_url('welcome')?>" class="dropdown-toggle notification notification--bullet cursor-pointer"><i data-lucide="user" class="notification__icon dark:text-slate-500"></i></a>
        ...
        <div class="wrapper-box">
            ...
            <nav class="side-nav">
                <ul>
                    ...
                    <li>
                        <a href="<?= base_url('categories/kompor') ?>" class="side-menu side-menu">
                    ...
                    <li>
                        <a href="<?= base_url('categories/mixer') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="shopping-bag"></i> </div>
                            <div class="side-menu__title">
                                Mixer
                    ...
                    <li>
                        <a href="<?= base_url('categories/panggangan') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="shopping-bag"></i> </div>
                            <div class="side-menu__title"> Panggangan </div>
                        </a>
                    </li>
                    <li>
                        <a href="<?= base_url('categories/wajan') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="shopping-bag"></i> </div>
                            <div class="side-menu__title"> Wajan </div>
                        </a>
                    </li>
                    <li>
                        <a href="<?= base_url('categories/freezer') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="shopping-bag"></i> </div>
                            <div class="side-menu__title"> Freezer </div>
                        </a>
                    </li>
