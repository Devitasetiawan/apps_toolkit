       ...
       <div class="grid grid-cols-12 gap-6 mt-5">
           <div class="intro-y col-span-12 flex flex-wrap xl:flex-nowrap items-center mt-2">
               <div class="flex w-full sm:w-auto">
                   ...
                   <select id="kategoriDropdown" class="w-48 xl:w-auto form-select box ml-2" onchange="tampilkanProduk()">
                       <option value="0">Kategori</option>
                       <option value="1">Wajan</option>
                       <option value="2">Kompor</option>
                       <option value="3">Panggangan</option>
