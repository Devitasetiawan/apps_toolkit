                ...
                <div class="box">
                    <div class="p-5">
                        ...
                        <div class="text-slate-600 dark:text-slate-500 mt-5">
                            ...
                            <div class="flex items-center mt-2"> <i data-lucide="layers" class="w-4 h-4 mr-2"></i> Stock Tersedia: <?= number_format($row->stok, 0, ',', '.') ?> </div>
                    ...
                    <div class="flex justify-center lg:justify-end items-center p-5 border-t border-slate-200/60">
                        <a class="flex items-center btn btn-sm btn-primary mr-10" href="<?= site_url('dashboard/cart/' . $row->id_brg) ?>" style="font-size: 12px; margin-right: 1px;">
                            <i data-lucide="shopping-cart" class="w-4 h-4 mr-1"></i> Add Cart
                        </a>
                    </div>
                </div>
            </div>
